...
The broker address is provided via \texttt{SPRING\_KAFKA\_BOOTSTRAP\_SERVERS} (see Docker Compose). Topics are created or ensured at runtime through a small helper that uses \texttt{KafkaAdmin}.
