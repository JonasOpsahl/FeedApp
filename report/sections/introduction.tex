...
and WebSocket notifications. The codebase includes authentication, core REST endpoints, and containerized 
one-command startup. It provides a clear baseline for the technology evaluation and sets up future hardening 
(durable database, stronger auth, observability, retries) without repeating other sections.
